...
namespace Naos.Service.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<NamedServiceLocator> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<NamedServiceLocator>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<NamedServiceLocator>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<NamedServiceLocator>();

                        var result = new SystemUnderTestExpectedStringRepresentation<NamedServiceLocator>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.Service.Domain.NamedServiceLocator: Name = {systemUnderTest.Name?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<NamedServiceLocator> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<NamedServiceLocator>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<NamedServiceLocator>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'name' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new NamedServiceLocator(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<NamedServiceLocator> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<NamedServiceLocator>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<NamedServiceLocator>
                {
                    Name = "Name should return same 'name' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<NamedServiceLocator>();

                        var result = new SystemUnderTestExpectedPropertyValue<NamedServiceLocator>
                        {
                            SystemUnderTest = new NamedServiceLocator(
        ...
        private static readonly DeepCloneWithTestScenarios<NamedServiceLocator> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<NamedServiceLocator>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<NamedServiceLocator>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<NamedServiceLocator>().ThatIs(_ => !systemUnderTest.Name.IsEqualTo(_.Name));

                        var result = new SystemUnderTestDeepCloneWithValue<NamedServiceLocator>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly NamedServiceLocator ReferenceObjectForEquatableTestScenarios = A.Dummy<NamedServiceLocator>();

        private static readonly EquatableTestScenarios<NamedServiceLocator> EquatableTestScenarios = new EquatableTestScenarios<NamedServiceLocator>()
            .AddScenario(() =>
                new EquatableTestScenario<NamedServiceLocator>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new NamedServiceLocator[]
                    {
                        new NamedServiceLocator(
                                ReferenceObjectForEquatableTestScenarios.Name),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new NamedServiceLocator[]
                    {
                        new NamedServiceLocator(
                                A.Dummy<NamedServiceLocator>().Whose(_ => !_.Name.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Name)).Name),
                    },
        ...
        public static class Structural
        {
            ...
            public static void NamedServiceLocator___Should_implement_IModel_of_NamedServiceLocator___When_reflecting()
            {
                // Arrange
                var type = typeof(NamedServiceLocator);

                var expectedModelMethods = typeof(IModel<NamedServiceLocator>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<NamedServiceLocator>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void NamedServiceLocator___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(NamedServiceLocator);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (NamedServiceLocator)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (NamedServiceLocator)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var property = typeof(NamedServiceLocator).GetProperty(propertyName);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<NamedServiceLocator>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                NamedServiceLocator systemUnderTest1 = null;
                NamedServiceLocator systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    NamedServiceLocator systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ServiceLocatorBase___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange
                    ServiceLocatorBase systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((ServiceLocatorBase)systemUnderTest);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ServiceLocatorBase___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((ServiceLocatorBase)scenario.ReferenceObject);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ServiceLocatorBase___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ServiceLocatorBase)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ServiceLocatorBase___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ServiceLocatorBase)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ServiceLocatorBase___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ServiceLocatorBase)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NamedServiceLocator___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NamedServiceLocator___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NamedServiceLocator___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NamedServiceLocator___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NamedServiceLocator___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
