...
namespace Naos.Service.Domain.Test
{
    ...
    {
        private static readonly ServiceLocatorBase ReferenceObjectForEquatableTestScenarios = A.Dummy<ServiceLocatorBase>();

        private static readonly EquatableTestScenarios<ServiceLocatorBase> EquatableTestScenarios = new EquatableTestScenarios<ServiceLocatorBase>()
            .AddScenario(() =>
                new EquatableTestScenario<ServiceLocatorBase>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ServiceLocatorBase[]
                    {
                        ReferenceObjectForEquatableTestScenarios.DeepClone(),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new ServiceLocatorBase[]
                    {
                    ...
                    ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject = new ServiceLocatorBase[]
                    {
                        A.Dummy<ServiceLocatorBase>().Whose(_ => _.GetType() != ReferenceObjectForEquatableTestScenarios.GetType()),
                    },
        ...
        public static class Structural
        {
            ...
            public static void ServiceLocatorBase___Should_implement_IModel_of_ServiceLocatorBase___When_reflecting()
            {
                // Arrange
                var type = typeof(ServiceLocatorBase);

                var expectedModelMethods = typeof(IModel<ServiceLocatorBase>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ServiceLocatorBase>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ServiceLocatorBase___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ServiceLocatorBase);
        ...
        public static class Cloning
        {
            ...
            {
                // Arrange
                var systemUnderTest = A.Dummy<ServiceLocatorBase>();

                // Act
                var actual = (ServiceLocatorBase)systemUnderTest.Clone();
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ServiceLocatorBase>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                ServiceLocatorBase systemUnderTest1 = null;
                ServiceLocatorBase systemUnderTest2 = null;
